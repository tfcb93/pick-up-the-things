...
@onready var inv_camera_toggle := $VBoxContainer/invert_camera;
...
func _ready() -> void:
	...
	inv_camera_toggle.button_pressed = globals.is_camera_inverted;
...
func _on_invert_scroll_toggled(toggled_on: bool) -> void:
	...
	events.emit_signal("invert_scroll", toggled_on);

func _on_show_mili_toggled(toggled_on: bool) -> void:
	globals.is_showing_miliseconds = toggled_on;

func _on_invert_camera_toggled(toggled_on: bool) -> void:
	globals.is_camera_inverted = toggled_on;
	events.emit_signal("invert_camera", toggled_on);
